            ...
            <Popover>
                ...
                <PopoverContent className="p-4 flex flex-col w-75">
                    <div className="w-full flex flex-col">
                        <span className="text-foreground mb-4 border-b border-border pb-3 font-medium">Filter</span>
                        <div className="w-full flex flex-col space-y-2.5">
                            <RadioGroup className="space-y-1.5 flex flex-col p-2.5 bg-muted/50 rounded-md">
