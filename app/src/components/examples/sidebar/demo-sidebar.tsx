...
const MainContent = ({ children }: { children: ReactNode }) => {
    return <main className="md:pl-64 flex-1 flex flex-col h-full relative overflow-hidden bg-background">
        <header className="h-14 bg-background border-b border-border-strong/60 flex items-center justify-between px-6 sticky top-0 z-10">
