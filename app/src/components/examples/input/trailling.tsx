    ...
    return (
        <form className="space-y-4 w-full max-w-xs text-foreground">
            <InputGroup>
                ...
                <InputTrailing absolute className="text-foreground">
            ...
            <InputGroup>
                ...
                <InputTrailing absolute className="text-sm text-foreground">
                    CDF
                </InputTrailing>
            </InputGroup>
            <InputGroup>
            ...
            <InputGroup>
                ...
                <InputTrailing className="px-3 text-foreground bg-bg-muted/80 rounded-r-ui">
                    <span className="flex text-lg iconify ph--at"></span>
                </InputTrailing>
            </InputGroup>
        </form>
