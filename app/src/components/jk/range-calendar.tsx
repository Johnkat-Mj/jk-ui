...
const cell = tv({
  ...
  variants: {
    selectionState: {
      ...
      'cap': 'bg-primary group-invalid:bg-destructive forced-colors:bg-[Highlight] forced-colors:group-invalid:bg-[Mark] text-white forced-colors:text-[HighlightText]'
    },
    isDisabled: {
          ...
          {(date) => <>
            <CalendarCell date={date}
              className={cx(
                ...
                "cell-radius outline-0 cursor-default outside-month:text-muted",
                "",
