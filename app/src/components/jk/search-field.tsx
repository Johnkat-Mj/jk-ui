    ...
    return (
        <InputGroup size={size} className={groupClass}>
            <InputLeading className='in-disabled:opacity-50' absolute>
                <span aria-hidden className="size-4 iconify ph--magnifying-glass text-muted-foreground/80 forced-colors:text-[ButtonText] group-disabled:text-muted-foreground/50 forced-colors:group-disabled:text-[GrayText]" />
            </InputLeading>
