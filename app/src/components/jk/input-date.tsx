...
const segmentStyles = tv({
  base: 'inline px-0.5 py-px whitespace-nowrap type-literal:p-0 rounded outline outline-0 forced-color-adjust-none caret-transparent text-muted-foreground forced-colors:text-[ButtonText] [-webkit-tap-highlight-color:transparent]',
  variants: {
    isPlaceholder: {
