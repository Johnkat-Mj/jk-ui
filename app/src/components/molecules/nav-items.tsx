...
export const NavItems = () => {
    const { isOpenNavbar } = useGlobalContext()
    return (
        ...
        ">
            <ul className="w-full flex flex-col lg:flex-row lg:items-center gap-0.5 text-muted-foreground bg-background lg:bg-transparent rounded-ui p-2 lg:p-0 border border-border dark:border-border-strong lg:border-none">
