    ...
    return (
        <>
            ...
            <aside data-state={isOpenSidebar ? "open" : "close"}
                ...
                className="docs-sidebar bg-background lg:bg-transparent z-120 lg:z-0 pt-4 border-r border-border lg:border-r-0 flex flex-col"
            >
                <Button
                    onPress={() => closeSidebar?.()}
                    aria-label="Close Sidebar"
                    className="size-8 text-foreground border border-border bg-background ease-linear absolute top-16 -right-3 flex items-center justify-center lg:hidden rounded-lg z-10"
                >
