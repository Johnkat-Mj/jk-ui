export const NoSearchIllustration = () => {
    return (
        <svg width="128" height="128" viewBox="0 0 128 128" fill="none"
            ...
            <path fillRule="evenodd" clipRule="evenodd"
                ...
                fill="#E4ECFE" className="fill-bg-muted" />
            <path
            ...
            <path d="M32.3401 51.3849V62.7251H21L32.3401 51.3849Z" fill="#2D56B2" className="fill-primary" />
            ...
            <path d="M63.6232 51.3849H99.5988L107.42 66.2444H71.444L63.6232 51.3849Z" fill="#88AAF4"
                className="fill-primary-400 dark:fill-primary-600/80" />
            ...
            <rect x="37" y="58" width="16" height="4" fill="#2D56B2" className="fill-primary" />
            <path d="M26 28.1207L32.4807 34.224" stroke="#2D56B2" strokeWidth="2" strokeLinecap="round"
                className="stroke-primary" />
            <path d="M38.7958 23L40.3815 30.7486" stroke="#2D56B2" strokeWidth="2"
                strokeLinecap="round" className="stroke-primary" />
            <path d="M102.541 28.1207L96.0598 34.224" stroke="#2D56B2" strokeWidth="2"
                strokeLinecap="round" className="stroke-primary" />
            <path d="M89.7448 23L88.1591 30.7486" stroke="#2D56B2" strokeWidth="2"
                strokeLinecap="round" className="stroke-primary" />
        </svg>
    )
}
