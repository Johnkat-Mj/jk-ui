    ...
    return (
        <section className="relative lg:mx-auto w-full lg:max-w-350 -mt-10 sm:-mt-16 md:-mt-19 px-1 pt-1 overflow-hidden flex flex-col justify-center">
            <div className="border-b border-border-strong/70 border-dashed divide-border-strong/70 divide-dashed min-w-[630px] min-[460px]:min-w-[890px] md:min-w-[1000px] w-full grid grid-cols-[300px_1fr] md:grid-cols-[360px_1fr] lg:grid-cols-[360px_1fr_360px]">
                <div className="p-4 relative border-t border-x bg-background/20 backdrop-blur-sm">
                    ...
                    <Card className="shadow-sm [--ui-padding:1.125rem]">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="space-y-0.5 flex flex-col">
                                <span className="font-semibold text-sm text-foreground">Johnkat MJ</span>
                                <p className="text-sm text-muted-foreground">johnkatmj@hmail.com</p>
                            </div>
                        </div>
                ...
                <div className="col-span-1 flex items-end relative">
                    <div className="w-full grid sm:grid-cols-2 h-26 border-t border-border-strong/20 border-dashed relative">
                        <div className="bg-background/20 backdrop-blur-sm flex items-center justify-center p-4 border-t border-r border-dashed border-border-strong/70 relative">
                            <SiteCaret className="-top-1 -left-1" />
                            <div className="max-h-full overflow-hidden flex size-full items-center justify-center">
                                <DemoTagWithStack />
                            </div>
                        </div>
                        <div className="max-sm:hidden bg-background/20 backdrop-blur-sm flex items-center justify-center p-4 relative border-t border-r lg:border-r-0 border-dashed border-border-strong/70">
                            <SiteCaret className="-top-1 -left-1" />
                            <DatePicker label="Date" />
                        </div>
                    </div>
                </div>
                <div className="col-span-1 p-4 flex items-center justify-center max-lg:hidden bg-background/20 backdrop-blur-sm border-t border-x border-dashed border-border-strong/70 relative">
                    <SiteCaret className="-top-1 -left-1" />
                    <SiteCaret className="-top-1 -right-1" />
                    <SiteCaret className="bottom-25 -left-1" />
                    <Card fill="none" className="h-max bg-card [--ui-padding:0.125rem]">
                        <div className="bg-background inner-radius p-3.5 flex flex-col">
                            <span className="font-semibold text-foreground">
                                Plan ui components V1
                            </span>
                            <div ></div>
                            <p className="my-1.5 text-muted-foreground text-sm line-clamp-1">
                            ...
                            <div className="flex flex-col pt1">
                                ...
                                <div className="pt-0.5 flex w-full text-xs justify-between text-muted-foreground">
                                    <span>On going</span>
                                    <div className="font-medium text-foreground">3/10</div>
                                </div>
                            </div>
                            <div className="flex justify-between mt-1.5">
                                <div className="flex -space-x-2">
                                    <Avatar src="/avatar1.webp" alt="Avatar 1" loading="lazy" size="xs"
                                        fetchPriority="auto" width="100" height="100" className="border border-muted" />
            ...
            <div className="border-b border-border-strong/70 border-x border-dashed divide-border-strong/70 divide-dashed divide-x min-w-[530px] min-[460px]:min-w-[740px] sm:min-w-[890px] md:min-w-[1000px] w-full grid grid-cols-[350px_1fr] md:grid-cols-[480px_1fr] lg:grid-cols-[650px_1fr]">
                ...
                <div className="w-full overflow-hidden grid">
                    <div className="p-4 relative grid lg:grid-cols-2 gap-4 h-max">
                        <div className="bg-background rounded-lg ring ring-border w-full px-3.5 py-6 flex flex-col items-center text-center">
                            ...
                            <p className="mt-2 mb-3 text-muted-foreground text-sm">No Schedules</p>
