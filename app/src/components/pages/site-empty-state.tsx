...
export const SiteEmptyState = ({ title, description, children }: { title: string, description: string, children?: React.ReactNode }) => {
    return (
        <div className="mx-auto w-full lg:max-w-300 border border-border-strong/70 py-14 border-dashed relative rounded-ui">
