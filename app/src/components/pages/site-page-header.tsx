    ...
    return (
        <section className="relative">
            ...
            <div
                ...
                <h2
                    className="font-bold text-3xl md:text-4xl/tight lg:text-5xl/[1.1] max-w-2xl text-balance text-transparent bg-clip-text bg-linear-to-br from-fg-title to-fg-muted/60 dark:via-foreground mt-4">
                    {title}
                </h2>
