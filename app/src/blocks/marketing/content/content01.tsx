    ...
    <section className="py-20 lg:py-32">
      <div className="px-5 sm:px-10 md:px-12 lg:px-5 lg:max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-16">
        <div className="md:py-16 lg:py-20 md:w-1/2 xl:w-[45%]">
          <h2 className="text-foreground font-medium text-3xl/snug max-w-xl">
        ...
        <div className="flex-1 lg:pl-20 relative flex justify-center">
          ...
          <div className="bg-background overflow-hidden shadow-lg shadow-bg-subtle/60 border border-border flex items-start gap-3 p-4 rounded-xl absolute -left-4 sm:left-8 lg:left-12 top-10">
            <span>
              <span className="iconify ph--eye flex text-foreground" />
            </span>
          ...
          <div className="select-none pointer-events-none w-54 flex flex-col gap-2 bg-background overflow-hidden shadow-lg shadow-bg-subtle/60 border border-border rounded-xl absolute right-0 bottom-4">
