            ...
            <div className="px-5 sm:px-10 md:px-12 lg:px-5 lg:max-w-7xl mx-auto w-full">
                <div className="flex flex-col md:flex-row md:justify-between md:items-end">
                    <div className="max-w-lg space-y-4">
                        <span className="block w-max border border-border shadow-sm text-foreground rounded-lg px-2 py-0.5">
                            Why us
                        </span>
                        <h1 className="font-semibold text-foreground text-3xl md:text-4xl/tight">
