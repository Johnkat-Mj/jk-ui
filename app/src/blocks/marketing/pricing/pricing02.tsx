                ...
                <div className="flex flex-col space-y-12">
                    <div className="flex gap-10 flex-col items-center">
                        <div className="mx-auto max-w-3xl text-center space-y-8">
                            ...
                            <h1 className="font-bold text-3xl md:text-4xl/tight text-foreground">
                                Flexible plans for every business
                            </h1>
                        </div>
                        <p className="max-w-lg mx-auto text-foreground text-center">
                    ...
                    <div className="grid gap-8 items-center sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="md-h-auto flex flex-col rounded-3xl p-5 sm:p-6 xl:p-10 border border-border">
                            ...
                            <p className="mt-5 sm:mt-6 text-foreground">
                                Perfect for small businesses looking to boost their online presence.
                            </p>
                            <ul className="flex flex-col space-y-3 mt-5 sm:mt-6 text-muted-foreground">
