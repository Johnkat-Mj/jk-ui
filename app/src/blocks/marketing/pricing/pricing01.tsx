...
export const Pricing01 = () => {
  ...
  <div className="px-5 sm:px-10 md:px-12 lg:px-5 lg:max-w-7xl mx-auto w-full flex flex-col gap-16">
    <div className="space-y-3 max-w-xl mx-auto flex flex-col text-center">
      <h2 className="text-foreground font-medium text-3xl md-text-4xl/tight">
        CRM Plans &amp; Pricing
      </h2>
      <p className="mx-auto max-wmd text-muted-foreground">
    ...
    <div className="mx-auto max-w-lg w-full md:max-w-4xl grid md:grid-cols-2 gap-6">
      {/* Essential Plan */}
      <div className="bg-background border border-border/40 shadow-lg shadow-bg-subtle/50 relative before:absolute before:inset-1 before:bg-card/40 before:inner-radius ui-card [--card-radius:var(--radius-3xl)] [--card-padding:--spacing(1)] pb-8 space-y-6">
        <div className="p-6 md:p-7 inner-radius bg-background border border-border shadow-lg shadow-bg-muted/20 relative">
          ...
          <h3 className="font-medium text-foreground text-lg mt-2">
            Essential
          </h3>
          ...
          <div className="flex items-end gap-x1 mt-3">
            <span className="flex items-end text-3xl sm:text-4xl lg:text-5xl font-semibold text-foreground">
              $29
        ...
        <div className="flex items-center flex-col gap-3 text-center px-6 md:px-7 relative">
          ...
          <div className="text-muted-foreground text-center flex gap-x-2 items-center">
