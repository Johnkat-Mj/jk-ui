  ...
  return (
    ...
    <li className="w-full flex">
      <a href={href} data-state={isActive ? 'active' : 'inactive'}
        className="w-full flex items-center text-sm gap-2.5 px-3 py-2 text-muted-foreground hover:bg-card hover:text-muted-foreground rounded-lg fx-current:bg-muted/60 fx-active:bg-muted/60 fx-current:text-foreground fx-active:text-foreground"
      >
