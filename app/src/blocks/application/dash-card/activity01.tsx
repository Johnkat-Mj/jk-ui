...
export const Activity01 = () => {
    return (
        <Card size="none" className="rounded-lg mx-auto max-w-sm my-5">
                    ...
                    <div className="flex-1 space-y-1">
                        <div className="flex items-center space-x-2">
                            ...
                            <p className="text-sm">
                                ...
                                <span className="text-muted-foreground ml-1">liked your article</span>
                            </p>
                        </div>
                        <p className="text-sm text-muted-foreground bg-muted p-2 rounded border-l-2 border-primary">
                ...
                <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex-1 space-y-1">
                        <div className="flex items-center space-x-2">
                            ...
                            <p className="text-sm">
                                <span className="font-medium text-foreground">Emma Wilson</span>
                                <span className="text-muted-foreground ml-1">shared your post</span>
                            </p>
                        </div>
                        <p className="text-sm text-muted-foreground bg-muted p-2 rounded border-l-2 border-primary">
