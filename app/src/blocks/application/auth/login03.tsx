        ...
        <main className="flex min-h-screen justify-center items-center px-5 sm:px-10 lg:px-0 py-5">
            <div className="flex flex-col gap-6 w-full max-w-sm">
                ...
                <form className="flex flex-col gap-4">
                    ...
                    <Separator label="Or continue" className="before:bg-muted" labelPlacement="middle"
                        labelClass="px-3 bg-background text-muted-foreground text-sm relative" />
                ...
                <p className="px-6 text-center text-muted-foreground mx-auto max-w-md text-sm mt-3">
