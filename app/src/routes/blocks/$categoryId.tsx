...
export const Route = createFileRoute('/blocks/$categoryId')({
  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        { title: `${category.title} Blocks | JK UI` },
        { name: 'description', content: category.description },
        { property: 'og:title', content: `${category.title} Blocks` },
        { property: 'og:description', content: category.description },
        { property: 'og:type', content: 'website' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: `${category.title} Blocks` },
  ...
  return (
    <>
      ...
      <section className="w-full lg:max-w-336 xl:max-w-352 mx-auto pt-12 px-3.5 sm:px-4 xl:px-8">
        <Breadcrumbs className="gap-2.5 whitespace-nowrap text-foreground capitalize text-sm md:text-base">
        ...
        <p className="max-w-lg text-sm md:text-base text-muted-foreground font-300 mt-1">
