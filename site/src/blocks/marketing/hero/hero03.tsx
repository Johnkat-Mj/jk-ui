                    ...
                    <nav className="w-full flex justify-between gap-6 relative">
                        <div className="min-w-max inline-flex relative">
                            <a href="/" className="relative flex items-center gap-3">
                                ...
                                <div className="inline-flex text-lg font-semibold text-fg-title">
                                    AgenceX
                                </div>
                            </a>
                        </div>
                        <NavbarBase className="invisible opacity-0 translate-y-10 lg:visible lg:opacity-100 fx-open:translate-y-0 fx-open:visible fx-open:opacity-100 lg:translate-y-0 duration-300 ease-linear overflow-hidden 
                            ...
                            <ul className="border-t border-border lg:border-t-0 p-6 lg:p-0 flex flex-col lg:flex-row gap-y-4 gap-x-3 text-fg w-full lg:justify-center lg:items-center">
                                <li>
                                    <a href="#" className="duration-300 font-medium ease-linear text-fg-muted hover:text-primary py-3">
                                        Case studies
                                    </a>
                                </li>
                                <li>
        ...
        <section className="relative pt-32 lg:pt-36">
            <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row gap-16">
                ...
                <div className="relative flex flex-col items-center text-center lg:text-left lg:py-7 xl:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
                    ...
                    <h1 className="text-3xl/tight sm:text-4xl/tight md:text-5xl/tight xl:text-6xl/tight font-bold text-fg-title mt-8">
                    ...
                    <p className="mt-8 text-fg max-w-md">
                    ...
                    <div className="mt-10 w-full flex max-w-md mx-aauto lg:mx-0 lg:max-w-none gap-3 items-center flex-wrap justify-center lg:justify-start">
                        ...
                        <a href="#" className="justify-center btn btn-lg btn-outline btn-outline-gray text-fg rounded-xl">
                            See our work
                        </a>
                    </div>
                </div>
                <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
                    ...
                    <div className="absolute w-64 left-1/2 -translate-x-1/2 -bottom-6 p-2 bg-bg/80 backdrop-blur-md border border-border-strong/50 rounded-xl shadow-sm shadow-bg-bg-muted/40 dark-shadow-transparent flex items-center before:absolute before:inset-x-3 before:h-2 before:flex before:bg-bg/80 before:border before:border-border-strong/50 before:border-t-none before:rounded-b-xl before:-bottom-2 before:shadow-sm before:shadow-bg-bg-muted/40 before:shadow-transparent">
                        ...
                        <div className="flex flex-col">
                            <span className="font-semibold text-xl text-fg-title">+20</span>
