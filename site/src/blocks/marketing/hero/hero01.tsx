                ...
                <nav
                    ...
                    <div className="flex items-center min-w-max relative">
                        <a href="#" className="font-semibold flex items-center gap-x-2">
                            <svg aria-hidden="true" width="488" height="488" className="size-8" viewBox="0 0 488 488"
                                ...
                                <g clipPath="url(#clip0_13_164)">
                                    <path
                                        ...
                                        fill="currentColor" className="text-fg-title"></path>
                                    <path
                            ...
                            <span className="text-lg text-fg">mySto</span>
                        </a>
                    </div>
                    ...
                    <NavbarBase
                        ...
                        <ul className="flex text-fg flex-col lg:flex-row gap-6 lg:items-center lg:w-full lg:pl-10">
                            <li className="">
                                <a href="#"
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 lg:min-w-max mt-10 lg:mt-0">
                            ...
                            <Button intent="solid-neutral" circle
                                className=" justify-center w-full sm:w-max rounded-full">
                                Sign-up
                            </Button>
                        </div>
        ...
        <section>
            <div className="w-full flex items-center relative">
                <div
                    ...
                    <a href="#"
                        className="flex items-center gap-x-2 mx-auto w-max px-2 pr-1 py-1 rounded-full bg-bg-surface border border-border-strong/40 text-sm text-fg">
                        mySto v2.1 is out
                        <span className="pr-1">
                            <span className="iconify ph--caret-right text-sm flex"></span>
                        </span>
                    </a>
                    <h1 className="mx-auto max-w-5xl font-semibold text-fg-title text-4xl/tight sm:text-5xl/tight lg:text-6xl/tight">
                        The Tool that lets you have full control on your stock & sales
                    </h1>
                    <p className="mx-auto max-w-2xl text-fg">
                    ...
                    <div className="flex flex-col items-center gap-5 w-full mx-auto max-w-md">
                        ...
                        <span className="text-center text-sm text-fg-muted inline-flex items-center">
