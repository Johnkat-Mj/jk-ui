...
const Navbar = () => {
    return (
        <NavbarProvider>
            ...
            <header className="sticky top-0 w-full flex items-center h-16 z-40 border-b border-border/50 bg-bg/20 backdrop-blur-xl">
                <nav className="px-5 sm:px-10 lg:px-5 relative mx-auto max-w-7xl w-full flex gap-x-5 justify-between items-center">
                    <div className="flex items-center min-w-max">
                        <a href="#" className="text-xl font-semibold text-fg flex items-center gap-x-2">
                            <span className="flex">
                    ...
                    <NavbarBase className="top-16 lg:top-0 left-0 bg-bg lg:bg-transparent
                        ...
                        <ul className="text-fg flex flex-col gap-6 lg:flex-row lg:items-center lg:w-full lg:justify-center">
                            <li>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-4 lg:min-w-max mt-10 lg:mt-0">
                            <a href="#" className="btn btn-sm btn-outline btn-outline-gray ease-linear duration-200 rounded-ui justify-center sm:w-max">
                                Request trial
                            </a>
                        </div>
                    </NavbarBase>
                    <div className="pl-3 flex items-center lg:hidden">
                        <NavbarToggler aria-label="toggle navbar" className="outline-none relative bg-transparent border-l border-border-strong group flex flex-col">
...
const HeroSection = () => {
    return (
        <section className="bg-primary-50/30 dark:bg-bg">
            ...
            <div className="relative mx-auto max-w-7xl w-full flex flex-col lg:flex-row gap-10 px-5 sm:px-10 md:px-12 lg:px-5 py-24 lg:py-3 lg:pb-4">
                <div className="lg:w-1/2 max-w-2xl md:max-w-3xl mx-auto flex flex-col md:justify-center text-center lg:text-left lg:py-24">
                    <a href="#" className="flex items-center w-max pl-0.5 pr-3 py-0.5 rounded-ui ui-subtle ui-subtle-gray mb-6 mx-auto lg:mx-0 text-sm">
                    ...
                    <p className="text-fg mt-7 mx-auto lg:mx-0 max-w-lg">
                    ...
                    <div className="mt-8 flex flex-col lg:flex-row justify-center items-center lg:justify-start gap-4">
                        <a href="#" className="justify-center btn btn-md btn-solid btn-solid-primary text-white rounded-ui">
                            Get Started
                        </a>
                    </div>
                    <div className="flex items-center gap-1 gap-x-2 mt-6 justify-center lg:justify-start py5">
                        <div className="flex items-center -space-x-1 *:size-8 *:object-cover *:rounded-ui *:ring-2 *:ring-bg">
                            <img src="/images/podCast.webp" width={2250} alt="listener avatar" />
                            <img src="/images/podCast.webp" width={2250} alt="listener avatar" />
                            <img src="/images/podCast.webp" width={2250} alt="listener avatar" />
                        </div>
                        <div className="flex flex-col justify-start items-start -space-y-1">
                            <span className="font-semibold text-fg-title">+12k</span>
                            <span className="text-sm text-fg-muted">Lovely users</span>
                        </div>
                    </div>
                </div>
