...
export const Cta02 = () => {
  return (
    <section className="py32 relative mxa wfull max-w-7xl">
      <div className="bg-bg b b-border rd-xl p10 sm-p14 !pb0 flex flex-col md-flex-row gap-14 overflow-hidden">
        <div className="space-y-8 max-w-lg md-max-w-none md-w6/12 lg-w2/5 md-py8">
          <h1 className="text-3xl font-semibold text-fg-title">
          ...
          <ul className="text-fg-muted grid grid-cols-2 gap-5">
