            ...
            <div className="px-5 sm:px-10 md:px-12 lg:px-5 lg:max-w-7xl mx-auto w-full flex flex-col space-y-16">
                <div className="flex gap-14 md:justify-between flex-col md:flex-row items-center">
                    <div className="text-center md:text-left md:max-w-lg space-y-5">
                        ...
                        <h2 className="font-semibold leading-tight text-fg-title text-3xl md:text-4xl xl:text-5xl">
                    ...
                    <div className="min-w-max flex justify-center md:justify-end">
                        <div className="rounded-xl bg-bg shadow-lg shadow-gray-200/40 dark:shadow-none flex items-center relative p-1">
                            <button data-state="active" className="btn btn-md w-max rounded-lg text-fg bg-transparent fx-active:text-white fx-active:bg-primary">
                                Monthly
                            </button>
                            <button data-state="inactive" className="btn btn-md w-max rounded-lg text-fg bg-transparent fx-active:text-white fx-active:bg-primary">
                                Yearly
                            </button>
                        </div>
                    </div>
                </div>
                <div className="grid divide-y divide-border lg:divide-y-0 gap-6 mx-auto lg:items-stretch lg:grid-cols-3 md:gap-8 lg:gap-12 bg-bg border border-border rounded-xl px-4 md:px-6 lg:px-8 pb-10">
                    {/* Free Plan */}
                    <div className="bg-bg pt-6 px-4 h-auto flex flex-col">
                        <div className="min-h-max mb-5">
                            <div className="relative flex items-end">
                                <div className="flex">
                                    <span className="text-4xl font-bold text-fg-title">$0</span>
                                </div>
                                <span className="text-fg">/month</span>
                            </div>
                            <h2 className="text-xl font-semibold text-fg-subtitle pt-5">
                                Free
                            </h2>
                            <p className="text-fg pt-2">
                        ...
                        <ul role="list" className="flex flex-col gap-2 text-fg">
                            <li className="flex gap-4 items-center">
                                <span className="bg-bg-surface text-sm text-fg px-2 py-1 rounded-full">✓</span>
                        ...
                        <div className="mt-5 flex flex-1 items-end min-h-max">
                            <a href="#" className="relative w-full btn btn-lg justify-center before:absolute before:inset-0 before:rounded-lg before:btn-outline before:btn-outline-gray before:transition before:duration-300 active-before:scale-95 rounded-md">
                                <span className="relative text-sm font-medium text-fg-muted">Continue for free</span>
                            </a>
                        </div>
                    </div>
                    {/* Team Plan */}
                    <div className="bg-bg pt-6 px-4 h-auto flex flex-col">
                        <div className="min-h-max mb-5">
                            <div className="relative flex items-end">
                                <div className="flex">
                                    <span className="text-4xl font-bold text-fg-title">$20</span>
                                </div>
                                <span className="text-fg">/month</span>
                            </div>
                            <h2 className="text-xl font-semibold text-fg-subtitle pt-5">
                        ...
                        <div className="mt-5 flex flex-1 items-end min-h-max">
                            <a href="#" className="relative w-full btn btn-lg justify-center before:absolute before:inset-0 before:rounded-lg before:btn-outline before:btn-outline-gray before:transition before:duration-300 active-before:scale-95 rounded-md">
                                <span className="relative text-sm font-medium text-fg-muted">Get started</span>
                            </a>
                        </div>
                    </div>
                    {/* Enterprise Plan */}
                    <div className="relative pt-6 px-4 mt-6 lg:mt-0 h-auto flex flex-col before:absolute before:z-0 before:scale-x-[1.13] sm:before:scale-x-[1.15] lg:before:scale-x-105 before:scale-y-105 lg:before:scale-y-110 before:inset-0 before:bg-gray-950 before:border before:border-border-strong before:rounded-xl">
