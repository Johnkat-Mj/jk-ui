            ...
            <main className="md:pl-64">
                ...
                <div className="flex-1 overflow-y-auto p-8 ">
                    <div className="lg:max-w-346 mx-auto animate-fade-in" id="main-content-area">
                        <div className="mb-8">
                            <h1 className="text-xl font-semibold tracking-tight text-fg-title">
                                Dashboard
                            </h1>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                            <div className="rounded-ui h-40 border border-border-strong/70">
                        ...
                        <div className="rounded-ui h-70 border border-border-strong/70">
