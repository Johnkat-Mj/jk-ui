...
export const EmptyState01 = () => {
    return (
        <div className="px-4 py-6 md:px-6 mx-auto max-w-5xl">
            <div className="flex w-full flex-col items-center text-center rounded-ui border border-border px-6 py-8 sm:py-12">
                <div className="size-12 ui-subtle ui-subtle-gray d-flex-place-center rounded-ui">
                    <span aria-hidden="true" className="size-5 iconify ph--user"></span>
                </div>
                <h2 className="text-fg-title text-lg font-semibold md:text-xl mt-4">
                    No User found
                </h2>
