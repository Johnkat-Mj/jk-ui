    ...
    return (
        <>
            ...
            <SidebarBase className={cx(
                "group w-64 bg-bg border-r border-border flex-col flex z-60 md:z-20 fixed left-0 transition-all duration-200 -translate-x-full invisible fx-open:visible fx-open:translate-x-0 md:translate-x-0 md:visible transform h-dvh",
                "md:fx-resized:w-16"
            )}>
                <div className="h-14 flex items-center px-3 border-b border-border-strong/60 relative">
                    <div className="w-full flex items-center gap-2.5 py-1.5 group text-left">
                        <div
                            className="size-8 min-w-8 bg-fg-title text-bg rounded-ui d-flex-place-center shadow-sm transition-colors duration-300">
                        ...
                        <div className="flex-1 md:in-fx-resized:invisible md:in-fx-resized:opacity-0 ease-linear duration-300">
                            <p className="text-sm font-medium text-fg-title truncate">
                                UnoFlex
                            </p>
                            <p className="text-[10px] text-fg-muted/60 font-medium truncate">
                                Sales
                            </p>
                        </div>
                ...
                <div className="p-3 border-t border-border-strong/60">
                    <Menu>
                        <Button variant="ghost" size="none" className="gap-3 w-full px-2 py-2 text-sm font-medium rounded-ui transition-colors">
                            <div
                                className="size-6 rounded-full bg-linear-to-tr from-bg-muted to-bg-surface d-flex-place-center text-fg-muted font-semibold ring-1 ring-bg">
                                JM
                            </div>
                            <div className="text-left flex-1 md:in-fx-resized:hidden">
                                <p className="text-xs font-medium text-fg-title truncate">Johnkat MJ</p>
                            </div>
