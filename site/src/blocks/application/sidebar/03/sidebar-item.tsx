  ...
  return (
    ...
    <li className="w-full flex">
      <a href={href} data-state={isActive ? 'active' : 'inactive'}
        className="w-full flex items-center text-sm gap-2.5 px-3 py-2 text-fg-muted hover:bg-bg-surface hover:text-fg-subtitle rounded-ui fx-current:bg-bg-muted/60 fx-active:bg-bg-muted/60 fx-current:text-fg-title fx-active:text-fg-title"
      >
