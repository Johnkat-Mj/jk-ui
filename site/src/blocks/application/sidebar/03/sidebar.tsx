...
export const Sidebar = () => {
    return (
        <>
            ...
            <SidebarBase
                className="fixed top-0 h-dvh bg-bg border-r border-border max-w-68 w-11/12 md:max-w-none md:w-68 p-4 -translate-x-full md:translate-x-0 left-0 fx-open:translate-x-0 opacity-0 fx-open:opacity-100 md:opacity-100 ease-linear duration-200 md:transition-[width] md:duration-200 z-60 md:z-auto md:fx-resized:w-19">
                <div className="flex flex-col size-full">
                    <div className="flex md:in-fx-resized:flex-col items-center gap-3 justify-between relative">
                        <a href="#">
                            <div className="size-9 md:in-fx-resized:w-10.5 bg-bg-surface border border-border-strong rounded-ui flex items-center justify-center ease-linear transition-[width]">
                                <svg width={700} height={700} className="size-8" viewBox="0 0 700 700" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_13_163)">
                                        <path d="M177.534 177L522.602 522.068C427.314 617.356 272.822 617.356 177.534 522.068C82.2463 426.78 82.2463 272.288 177.534 177Z" fill="currentColor" className="text-fg-title" />
                                        <path d="M589.659 355.5C589.659 380.629 542.788 450.5 517.659 450.5C492.53 450.5 498.659 380.629 498.659 355.5C498.659 330.371 519.03 310 544.159 310C569.288 310 589.659 330.371 589.659 355.5Z" fill="currentColor" className="text-fg-title" />
                                        <circle cx="349.429" cy="349.759" r={110} transform="rotate(48.3973 349.429 349.759)" fill="currentColor" stroke="white" strokeWidth={80} className="text-fg-title stroke-bg" />
                                        <path d="M415 177C415 202.129 318.629 207 293.5 207C268.371 207 248 186.629 248 161.5C248 136.371 268.371 116 293.5 116C318.629 116 415 151.871 415 177Z" fill="currentColor" className="text-fg-title" />
                                        <path d="M523 207.5C523 232.629 521.129 321.5 496 321.5C470.871 321.5 432 232.629 432 207.5C432 182.371 452.371 162 477.5 162C502.629 162 523 182.371 523 207.5Z" fill="currentColor" className="text-fg-title" />
                                    </g>
                                    <defs>
                        ...
                        <div className="md:flex hidden ">
                            <SidebarResizer variant="ghost" size="sm" icon-only data-toggle-sidebar-size className="md:in-fx-resized:w-10.5">
                    ...
                    <div className="mt-6">
                        <form className="relative w-full">
                            <InputGroup className="md:in-fx-resized:[--left-space:12px]">
                                ...
                                <InputLeading absolute className="text-fg text-sm">
                                ...
                                <li className="flex w-full">
                                    <Menu>
                                        <Button intent="none" variant="none" size="none"
                                            className="flex items-center text-sm gap-2.5 md:in-fx-resized:pl-0 px-1 py-1 text-fg-muted hover:bg-bg-surface hover:text-fg-subtitle rounded-ui w-full">
                                            <span
                                                className="size-8 min-w-8 md:in-fx-resized:w-10.5 md:in-fx-resized:min-w-10.5 flex items-center justify-center rounded-ui ui-subtle ui-subtle-gray">
                                                J
                                            </span>
                                            <span
                                        ...
                                        <MenuContent popover={{ placement: "right bottom" }} className="min-w-54">
                                            <MenuHeader separator>
                                                ...
                                                <span className="font-normal text-fg-muted">@katmj</span>
                                            </MenuHeader>
