    ...
    return (
        <>
            ...
            <SidebarBase className="
                ...
                left-1.5 inset-y-1.5 z-100 flex flex-col overflow-hidden bg-gray-950 border border-gray-800/50 dark:border-gray-800 rounded-ui dark:bg-gray-800/50
            ...
            ">
                <div className="px-2 py-1 pb-4 border-b border-white/10">
                    <div className="flex items-center gap-3 pt-2">
                        <div className="min-w-9 bg-primary text-white size-9 rounded-ui d-flex-place-center">
