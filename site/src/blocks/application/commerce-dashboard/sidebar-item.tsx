    ...
    return (
        <li
            ...
            <a href={href} data-state={isActive ? 'active' : null} aria-label={`Link to ${text}`}
                className="flex items-center gap-3 px-3 h-9 w-full fx-active:bg-muted/60 fx-active:text-foreground text-muted-foreground hover:bg-muted/50 rounded-lg text-sm">
