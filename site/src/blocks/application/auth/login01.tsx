...
export const Login01 = () => {
    return (
        <main className="flex min-h-screen justify-center items-center px-4 sm:px-10 lg:px-0 py-5">
            <Card size="none" className="rounded-ui p-6 sm:p-8 flex flex-col w-full max-w-md">

                <div className="text-center mb-8">
                    <div className="size-12 bg-primary text-white text-xl rounded-ui flex items-center justify-center mx-auto mb-4">
                    ...
                    <h2 className="text-2xl font-semibold text-fg-title">Welcome back</h2>
                    <p className="text-fg-muted mt-1">Sign in to your account</p>
                </div>
                ...
                <form className="space-y-4" id="login-form">
                    ...
                    <div className="space-y-2">
                        ...
                        <InputGroup>
                            ...
                            <InputTrailing absolute clickable className="text-fg">
                                <button type="button" className="flex items-center cursor-pointer">
                                    <span className="iconify ph--eye text-fg-muted/80"></span>
                                </button>
                            </InputTrailing>
                        </InputGroup>
                    </div>
                ...
                <Separator labelPlacement="middle" label="Or continue with" className="before:bg-bg-muted my-6"
                    labelClass="px-3 bg-bg text-fg relative" />
