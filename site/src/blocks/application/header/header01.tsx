...
export const Header01 = () => {
    return (
        <header className="sticky top-0 z-50 px-2 md:px-4 pt-2">
            <nav className="bg-bg border border-border rounded-lg p-4 h-16 flex items-center">
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center space-x-4">
                        ...
                        <h1 className="font-semibold text-fg-title hidden truncate sm:inline-flex" data-testid="header-title">
                            Dashboard Overview
                        </h1>
                    </div>
                        ...
                        <form className="w-full relative">
                            <InputGroup>
                                ...
                                <InputLeading absolute>
                                    <span className="iconify ph--magnifying-glass text-xs text-fg-muted"></span>
                                </InputLeading>
                            </InputGroup>
                        </form>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <Button size="sm" iconOnly variant="ghost" className="relative">
                            ...
                            <span
                                className="absolute -top-1 -right-1 size-4 bg-danger text-white text-xs rounded-full flex items-center justify-center"
                        ...
                        <div
                            ...
                            <div className="hidden md:flex flex-col flex-1">
                                <p className="text-sm font-medium text-fg-title line-clamp-1">
                                    Tresor Kasenda
                                </p>
                            ...
                            <span aria-hidden="true" className="iconify ph--caret-down text-xs text-fg-muted"></span>
                        </div>
                    </div>
                </div>
            </nav>
