...
export const Header02 = () => {
    return (
        <header className="h-14 bg-bg border-b border-border flex items-center justify-between px-6 sticky top-0 z-10">
            <div className="flex items-center gap-4">
                ...
                <Breadcrumbs className="text-xs sm:text-sm text-fg-muted">
