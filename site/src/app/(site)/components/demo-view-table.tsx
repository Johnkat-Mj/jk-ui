...
const getBadgeProps = (role: string) => {
    return role === 'admin'
        ? { variant: 'solid' as const, intent: 'solid-neutral' as const }
        : { variant: 'subtle' as const, intent: 'subtle-gray' as const }
}
        ...
        <div className="grid grid-rows-[auto_1fr_auto] border border-border-strong/40 dark:border-border bg-bg dark:bg-bg-surface/40 rounded-ui">
            <div className="relative z-11 p-4 flex gap-4 flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button intent="solid-neutral" size="sm">
                                ...
                                <NativeTableCell className="pl-2">
                                    <div className="flex items-center gap-2">
                                        {user.info.avatar !== '' ? (
                                            <Avatar
                                                radius="none"
                                                className="rounded-ui bg-bg-muted/60"
                                                size="sm"
