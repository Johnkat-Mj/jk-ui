...
export function SliderOutput({
  ...
  return (
    <PrimitiveSliderOutput
      className={cx("font-medium text-fg-muted text-base/6 sm:text-sm/6", className)}
      {...props}
    />
  )
}
...
export function SliderThumb({
  ...
  return (
    <PrimitiveSliderThumb
      className={cx(
        "top-[50%] left-[50%] size-5 rounded-full border-2 border-current bg-bg outline-hidden ring-black transition-[width,height]",
        className,
      )}
      {...props}
    />
