...
const tooltipStyles = tv({
  base: [
    "group origin-(--trigger-anchor-point) rounded-lg border border-(--tooltip-border) px-2.5 py-1 text-sm/6 will-change-transform [--tooltip-border:var(--color-fg-muted)]/30 dark:shadow-none *:[strong]:font-medium",
  ],
  variants: {
    inverse: {
      true: "border-transparent bg-fg text-bg **:[.text-fg-muted]:text-bg/80",
      false: "bg-overlay text-fg",
    },
    isEntering: {
      true: [
        "fade-in animate-in",
