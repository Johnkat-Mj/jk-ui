...
export const PreviewAsIFrame = ({ preview }: { preview: string }) => {
    ...
    return (
        <div className="w-full h-96 bg-bg duration-300 ease-linear ui-preview-frame
    flex relative overflow-hidden">
            {
                frameIsLoading ? <Skeleton aria-hidden radius="none" className="rounded-ui absolute inset-0" /> : null
            }
            <iframe src={preview}
