import "../_runtime.mjs";
import { RouterProvider, defineHandlerCallback, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound, isRedirect, isResolvedRedirect, isSsrResponse, normalizeSsrResponse, renderRouterToStream, replaceSsrResponse, require_jsx_runtime, require_react, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody } from "../_libs/@tanstack/react-router+[...].mjs";
import { createMemoryHistory } from "../_libs/tanstack__history.mjs";
import { Ou, attachRouterServerSsrUtils, createRawStreamRPCPlugin, createSerializationAdapter, cu, defaultSerovalPlugins, getNormalizedURL, getOrigin, lu, makeSerovalPlugin, mergeHeaders } from "../_libs/@tanstack/router-core+[...].mjs";
import { H3Event, toResponse } from "../_libs/h3-v2+rou3.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Dve_YTrP.mjs");
