...
var DOT_SEGMENT_RE = /(?:^|\/)(?:\.|%(?:25)*2e){1,2}(?:\/|$)/i;
var ENCODED_SEP_RE = /%(?:25)*(?:2f|5c)/i;
var ENCODED_SEP_RE_G = new RegExp(ENCODED_SEP_RE.source, "gi");
...
//#endregion
export { FastURL, H3Core, HTTPError, NodeResponse, defineHandler, defineLazyEventHandler, resolveDotSegments, serve, toEventHandler, toRequest };
