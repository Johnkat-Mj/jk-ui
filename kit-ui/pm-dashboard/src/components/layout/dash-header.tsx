...
export const DashHeader = () => {
	return (
		<header className="sticky top-0 h-16 flex items-center border-b bg-background border-border z-35">
			<Container className="flex items-center justify-between gap-3">
				<div className="flex items-center gap-4">
					...
					<span className="font-semibold text-foreground sm:inline-flex hidden">
						Projects
					</span>
				</div>
				<div className="flex items-center gap-1.5 flex-1 justify-end min-w-max">
					...
					>
						<span aria-hidden="true" className="iconify ph--folder-plus mr-1.5" />
						New Project
					</Button>
						...
						<Menu>
							...
							>
								<MenuHeader separator>
									<span className="block">Sarah Chen</span>
								...
								<MenuSection>
									<MenuItem href="#dashboard">
										<MenuIcon aria-hidden="true">
											<span className="iconify ph--square" />
										</MenuIcon>
								...
								<MenuItem>
									<MenuIcon aria-hidden="true">
										<span className="iconify ph--terminal" />
									</MenuIcon>
