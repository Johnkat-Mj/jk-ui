...
export const channels = [
	...
	{ name: "Organic Search", percentage: 28, color: "bg-primary/80" },
	{ name: "Social Media", percentage: 20, color: "bg-primary/65" },
	{ name: "Email", percentage: 12, color: "bg-primary/50" },
	{ name: "Referral", percentage: 5, color: "bg-primary/35" },
];
