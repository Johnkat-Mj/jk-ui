...
export const SiteFooter = () => {
  return (
    <footer className="pt-24 md:pt-32 bg-box flex flex-col">
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="pt-8 space-y-6">
            <p className="text-fg md:text-lg leading-6">
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-2">
          ...
          <div className="col-span-2 sm:col-span-1">
            <div>
              <h2 className="font-semibold text-fg-title md:text-lg">Contact Us</h2>
              <ul
                role="list"
      ...
      <div className="py-2 bg-bg">
        <div
          className="w-full max-w-7xl px-5 sm:px-10 xl:px-14 mx-auto flex items-center justify-between gap-8 text-fg"
        >
          <div>
