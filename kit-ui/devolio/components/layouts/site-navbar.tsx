  ...
  return (
    <header className={
      cx(
        ...
        scrollY > 100 ? "fixed py-1.5 bg-bg/70 backdrop-blur-sm border-border" : "py-5 absolute border-transparent"
      )
    }>
      ...
      <SiteContainer className="relative">
        <nav className="flex justify-between gap-4 items-center py-3">
          ...
          <div className={
            ` fixed h-screen py-10 px-4 lg:px-0 lg:py-0 bg-bg lg:bg-transparent top-0 z-60 w-5/6 max-w-sm lg:max-w-none lg:h-auto lg:visible lg:relative flex flex-col lg:flex-row lg:justify-between lg:w-full duration-300 ease-linear
            ...
            <div className="flex min-w-max pt-10 lg:pt-0">
              <Link href={"#"} className={buttonStyles({ variant: "ghost", className: "flex justify-center w-full sm:w-max border border-gray-400/80 dark:border-gray-600" , size:"sm",})}>
                Contact Us
              </Link>
            </div>
