		...
		<MenuSubMenu>
			<MenuItem>
				<MenuIcon aria-hidden="true">
					<span className="iconify hugeicons--paint-board" />
				</MenuIcon>
			...
			<MenuContent>
				<MenuItem onAction={() => changeTheme("auto")}>
					<MenuIcon aria-hidden="true">
						<span className="iconify hugeicons--laptop-settings" />
					</MenuIcon>
					<MenuLabel>System</MenuLabel>
				</MenuItem>
				<MenuItem onAction={() => changeTheme("dark")}>
					<MenuIcon aria-hidden="true">
						<span className="iconify hugeicons--moon-01" />
					</MenuIcon>
					<MenuLabel>Dark</MenuLabel>
				</MenuItem>
				<MenuItem onAction={() => changeTheme("light")}>
					<MenuIcon aria-hidden="true">
						<span className="iconify hugeicons--sun-02" />
					</MenuIcon>
