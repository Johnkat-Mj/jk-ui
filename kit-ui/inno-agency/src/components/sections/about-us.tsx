...
export const AboutUs = () => {
    return (
        <section
            id="about"
            className="relative bg-muted/30 dark:bg-muted/20 border-t border-border py-20 px-5 sm:px-10 md:px-12 lg:px-5 lg:max-w-7xl mx-auto w-full flex flex-col md:flex-row gap-16 rounded-3xl xl:px-16"
        >
            <div
                aria-hidden="true"
            ...
            <div className="md:py-16 md:w-1/2 xl:w-[45%] relative">
                ...
                <ul
                    className="mt-7 border px-3 rounded-lg bg-background/40 border-border/50 text-muted-foreground divide-y divide-border *:py-2"
                >
