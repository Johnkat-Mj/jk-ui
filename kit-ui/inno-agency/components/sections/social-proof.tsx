...
export const SocialProof = () => {
  return (
    <section className="bg-bg-surface/50 dark:bg-bg-surface/20 py-10 relative">
      <div className="absolute inset-0 ui-grid ui-striped-overlay-mask-reverse [--unify-ui-grid-width:24px] [--unify-ui-grid-height:24px] text-fg-muted/10 dark:text-primary/10 opacity-50">
      </div>
      ...
      <div className="mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col relative">
        <span className="mx-auto text-center text-fg-muted text-sm">
          Build lasting relationships with complete customer solutions
        </span>
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 mt-7">
          <div className="bg-bg/40 backdrop-blur-sm backdrop-saturate-150 border border-border-strong/40 shadow-lg shadow-bg-subtle/50 relative before:absolute before:inset-0.5 before:border before:border-border/60 before:inner-radius p-(--card-padding) rounded-(--card-radius) [--card-padding:--spacing(0.5)] [--card-radius:var(--radius-lg)]">
            <div className="px-5 lg:px-6 lg:pt-6 pt-5 flex justify-between items-start relative">
              <div className="flex flex-col flex-1">
                <h3 className="text-xl font-medium text-fg">+450</h3>
                <p className="text-sm text-fg-muted">Happy Clients</p>
              </div>
              <div className="bg-muted/80 rounded-md size-11 text-fg relative flex items-center justify-center text-xl">
          ...
          <div className="bg-bg/40 backdrop-blur-sm backdrop-saturate-150 border border-border-strong/40 shadow-lg shadow-bg-subtle/50 relative before:absolute before:inset-0.5 before:border before:border-border/60 before:inner-radius p-(--card-padding) rounded-(--card-radius) [--card-padding:--spacing(0.5)] [--card-radius:var(--radius-lg)]">
            <div className="px-5 lg:px-6 lg:pt-6 pt-5 flex justify-between items-start relative">
              <div className="flex flex-col flex-1">
                <h3 className="text-xl font-medium text-fg">98%</h3>
                <p className="text-sm text-fg-muted">Retention Rate</p>
              </div>
              <div className="bg-muted/80 rounded-md size-11 text-fg relative flex items-center justify-center text-xl">
          ...
          <div className="bg-bg/40 backdrop-blur-sm backdrop-saturate-150 border border-border-strong/40 shadow-lg shadow-bg-subtle/50 relative before:absolute before:inset-0.5 before:border before:border-border/60 before:inner-radius p-(--card-padding) rounded-(--card-radius) [--card-padding:--spacing(0.5)] [--card-radius:var(--radius-lg)]">
            <div className="px-5 lg:px-6 lg:pt-6 pt-5 flex justify-between items-start relative">
              <div className="flex flex-col flex-1">
                <h3 className="text-xl font-medium text-fg">10M+</h3>
                <p className="text-sm text-fg-muted">Leads Generated</p>
              </div>
              <div className="bg-muted/80 rounded-md size-11 text-fg relative flex items-center justify-center text-xl">
